...
const ARTICLE_SLUG = 'conseils-aux-adoptants-pour-les-lapins'

export async function generateMetadata(): Promise<Metadata> {
  return generateArticleMetadata(ARTICLE_SLUG)
}

export default async function ConseilsLapinsPage() {
  return (
    <ArticlePageLayout
      slug={ARTICLE_SLUG}
      breadcrumbs={[
        ...
        { name: 'Conseils pour les lapins', url: getPageUrl(ARTICLE_SLUG) },
      ]}
      backButton={{
        href: '/adoptants',
