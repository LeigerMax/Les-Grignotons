...
export const metadata: Metadata = {
  title: 'Adoptions - Cobayes',
  description: 'Découvrez nos bébés cobayes disponibles à l\'adoption. Élevage familial responsable avec sevrage tardif.',
  openGraph: {
    title: 'Adoptions Cobayes - Les Grignotons',
    description: 'Découvrez nos bébés cobayes disponibles à l\'adoption. Élevage familial responsable avec sevrage tardif.',
    url: getPageUrl('adoption/cobayes'),
    images: [SITE_CONFIG.defaultImages.og],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Adoptions Cobayes - Les Grignotons',
    description: 'Découvrez nos bébés cobayes disponibles à l\'adoption.',
  },
  alternates: {
    canonical: getPageUrl('adoption/cobayes'),
  },
}

export default async function AdoptionCobayesPage() {
  const allAnimals = await getAnimals()
  const adoptionCobayes = allAnimals.filter(
    (animal) => animal.animalType === 'adoption' && animal.species === 'Cobaye'
  )
      ...
      <Section className="bg-gradient-to-b from-primary to-beige text-white py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl leading-relaxed">
            Découvrez nos bébés cobayes disponibles à l'adoption.
            <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 border-primary hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700">
                ...
                <Link href="/conseils-aux-adoptants-pour-les-cobayes" className="text-primary font-semibold hover:underline">
                  Conseils aux adoptants
                </Link>
                {' '}et{' '}
                <Link href="/race-et-couleurs-les-cobayes" className="text-primary font-semibold hover:underline">
                  Race et couleur
                </Link>
                .
              </p>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border-t-4 color-secondary hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700">
                Nos cobayes sont sevrés tardivement pour garantir leur bonne santé et leur développement optimal.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Découvrez nos cobayes
              </h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Parcourez les fiches de nos bébés cobayes disponibles ci-dessous
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Posez vos questions et organisez une visite pour rencontrer le cobaye de votre choix
              </p>
            </div>
      ...
      <Section className="bg-gradient-to-b from-primary/10 to-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 leading-relaxed">
            N'hésitez pas à nous contacter pour toute question sur nos cobayes, 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/conseils-aux-adoptants-pour-les-cobayes"
